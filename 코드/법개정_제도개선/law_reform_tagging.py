...
# 0. 경로 및 국회 임기 설정
# -------------------------------------------------------------------
SCRIPT_DIR = Path(__file__).resolve().parent          # .../코드/법개정_제도개선
BASE_DIR   = SCRIPT_DIR.parent                        # .../코드
DATA_DIR   = BASE_DIR / "데이터수집" / "data"          # .../코드/데이터수집/data
...
def compute_and_save_stats(df: pd.DataFrame):
    ...
    for assembly_no in [20, 21, 22]:
        output_path = SCRIPT_DIR / f"law_reform_stats_{assembly_no}.csv"
